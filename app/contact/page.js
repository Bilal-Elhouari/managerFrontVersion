  ...
  const contactMethods = [
      {
          ...
          ,
          contact: "Support@jobs4talents.com"
      },
      {
          icon:
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
              <div className="max-w-lg mx-auto gap-12 justify-between lg:flex lg:max-w-none">
                  <div className="max-w-lg space-y-3">
                      ...
                      <p>
                      Nous sommes là pour vous aider et répondre à toutes vos questions. Nous avons hâte de vous entendre ! Veuillez remplir le formulaire ou utiliser les coordonnées ci-dessous.
                      </p>
                      <div>
