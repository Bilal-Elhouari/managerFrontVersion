      ...
      <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
        ...
        <img
          ...
          <div className=" mt-16 space-y-3">
            <h3 className="text-white text-3xl font-bold">Commencez à développer votre entreprise rapidement</h3>
            <p className="text-gray-300">
              Créez un compte et accédez à toutes les fonctionnalités pour bien gérer votre entreprise.
            </p>
